  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <div>
        <div className="hidden lg:flex lg:gap-4">
          {!user ? (
            ...
            <button
              className="w-10 h-10 outline-none rounded-full ring-offset-2 ring-blue-200 ring-2 lg:focus:ring-indigo-600 hidden lg:inline"
              onClick={(e) => {
                e.stopPropagation();
                setIsOpen(!isOpen);
              }}
        ...
        <div>
          {user ? (
            <button
              className="w-10 h-10 outline-none rounded-full ring-offset-2 ring-blue-200 ring-2 lg:focus:ring-indigo-600 lg:hidden"
              onClick={(e) => {
                e.stopPropagation();
                setIsOpen(!isOpen);
              }}
      ...
      <div
        ...
        } z-10 top-12 right-0 bg-white p-5 rounded-2xl border-blue-200 border-2`}
      >
